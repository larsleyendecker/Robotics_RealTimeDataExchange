...
if("TRUE" STREQUAL "TRUE")
  set(ur_robot_driver_SOURCE_PREFIX /home/lars/rtde_ws/src/Universal_Robots_ROS_Driver/ur_robot_driver)
  set(ur_robot_driver_DEVEL_PREFIX /home/lars/rtde_ws/devel)
  ...
  set(ur_robot_driver_INSTALL_PREFIX /home/lars/rtde_ws/install)
...
if(NOT "/home/lars/rtde_ws/src/Universal_Robots_ROS_Driver/ur_robot_driver/include;/usr/include " STREQUAL " ")
  set(ur_robot_driver_INCLUDE_DIRS "")
  set(_include_dirs "/home/lars/rtde_ws/src/Universal_Robots_ROS_Driver/ur_robot_driver/include;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ur_robot_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lars/rtde_ws/src/Universal_Robots_ROS_Driver/ur_robot_driver/${idir}'.  ${_report}")
    endif()
...
set(depends "actionlib;control_msgs;controller_manager;geometry_msgs;hardware_interface;pluginlib;roscpp;sensor_msgs;tf;tf2_geometry_msgs;tf2_msgs;trajectory_msgs;ur_controllers;ur_dashboard_msgs;ur_rtde_msgs;ur_msgs;std_srvs")
