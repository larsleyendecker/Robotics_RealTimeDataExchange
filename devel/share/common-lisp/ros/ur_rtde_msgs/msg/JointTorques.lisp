...
(cl:defmethod cl:initialize-instance :after ((m <JointTorques>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointTorques)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ur_rtde_msgs-msg:<JointTorques> is deprecated: use ur_rtde_msgs-msg:JointTorques instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <JointTorques>))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<JointTorques>)))
  ...
  (cl:format cl:nil "# This message holds data to describe the torques of all robot joints.~%~%float64[] data~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'JointTorques)))
  "Returns full string definition for message of type 'JointTorques"
  (cl:format cl:nil "# This message holds data to describe the torques of all robot joints.~%~%float64[] data~%~%~%"))
