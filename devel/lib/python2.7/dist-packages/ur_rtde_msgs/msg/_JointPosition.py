...
"""autogenerated by genpy from ur_rtde_msgs/JointPosition.msg. Do not edit."""
import sys
...
class JointPosition(genpy.Message):
  ...
  _type = "ur_rtde_msgs/JointPosition"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# This message holds data to describe the positions of all robot joints.
